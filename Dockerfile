from openjdk:11
RUN wget https://www-eu.apache.org/dist/jena/binaries/apache-jena-3.10.0.tar.gz 
RUN tar xfvz apache-jena-3.10.0.tar.gz
RUN sed -i 's/WARN/INFO/g' ./apache-jena-3.10.0/jena-log4j.properties
